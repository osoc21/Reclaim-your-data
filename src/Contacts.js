...
const contactsWebIdQuery= "SELECT ?o WHERE { ?s <http://www.w3.org/2006/vcard/ns#value> ?o }";
...
function Contacts(props)
{
	...
	async function fetchContacts(){
		...
		let resBindings = await executeQuery(contactsWebIdQuery,[contactsWebIdSource], session);
